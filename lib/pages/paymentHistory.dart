  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          //for degree students
          if (user.diplomaORdegree == "Degree") ...[
                              ...
                              Center(
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        //Show Pending or success
                                        if (authService
                                                .paymenthistoryList[index]
                                                .paymentStatus ==
                                            "Pending") ...[
                                          //for successfull registerd
          ...
          if (user.diplomaORdegree == "Diploma") ...[
            //expended because we use list and that display on screen and list size is big so expanded increse size
            Expanded(
              //for showing a API data we use future builder
              child: FutureBuilder(
                future: authService.getPaymentHistoryDiploma(
                    context: context, userId: user.uid),
                builder: (context, snapshot) {
                  //if data is not avalible
                  if (!snapshot.hasData) {
                    return authService.paymenthistoryListDiploma.length == null
                        ? Column(
                            children: [
                              //image
                              Padding(
                  ...
                  //if data is avalible
                    ...
                    return ListView.builder(
                        itemCount: authService.paymenthistoryListDiploma.length,
                        itemBuilder: (context, index) {
                          //for shoring Payment History
                          return Column(
                            children: [
