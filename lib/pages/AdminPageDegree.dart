...
class AdminPageDegree extends StatefulWidget {
  const AdminPageDegree({super.key});

  @override
  State<AdminPageDegree> createState() => _AdminPageDegreeState();
}

class _AdminPageDegreeState extends State<AdminPageDegree> {
  ...
  //For Degree
  //get Payment Details for Degree method
  List<DegreePaymentDetails> paymentDetailsDegree = [];
  void paymentsDetailsDegree() async {
    ...
    if (ip.hasInternet == false) {
      ...
      List<DegreePaymentDetails> paymentDetailsDegree =
          await authService.getPaymentDetailsForAdmin(
        context: context,
        cuponCode: cuponCodeController.text,
      );

      setState(() {
        this.paymentDetailsDegree = paymentDetailsDegree;
      });
    }
  }
  ...
  void UpdatePaymentStutasDegree() async {
    ...
    if (ip.hasInternet == false) {
      ...
      authService.UpdatePaymentStatus(
        context: context,
        cuponCode: cuponCodeController.text,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        itemCount: paymentDetailsDegree.length,
                        itemBuilder: (context, index) {
                          DegreePaymentDetails paymentDetail =
                              paymentDetailsDegree[index];
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "Talaash: ${paymentDetail.GameTalaash}",
                                        style: TextStyle(
                                          fontFamily: 'OpenSanse',
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "Tech-Tainment: ${paymentDetail.GameTechTainment}",
                                        style: TextStyle(
                                          fontFamily: 'OpenSanse',
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "The Civil Safari: ${paymentDetail.GameTheCivilSafari}",
                                        style: TextStyle(
                                          fontFamily: 'OpenSanse',
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "Dekathon: ${paymentDetail.GameDekathon}",
                                        style: TextStyle(
                                          fontFamily: 'OpenSanse',
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "Office Tennis: ${paymentDetail.GameOfficeTennis}",
                                        style: TextStyle(
                                          fontFamily: 'OpenSanse',
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15,
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        "Scavenger Hunt: ${paymentDetail.GameScavengerHunt}",
                                        style: TextStyle(
                                          fontFamily: 'OpenSanse',
                                          fontWeight: FontWeight.w600,
                                          fontSize: 15,
