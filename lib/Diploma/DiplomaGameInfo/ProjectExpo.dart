...
class ProjectExpo extends StatefulWidget {
  const ProjectExpo({super.key});

  @override
  State<ProjectExpo> createState() => _ProjectExpoState();
}
...
class _ProjectExpoState extends State<ProjectExpo> {
  ...
  void _handleTap() {
    ...
    cart.addItem(
      CartItem(name: "ProjecExpo", price: 40, quantity: 4),
    );
  }
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "In This event final year studnt show their project model and give presentation on it",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
                    ...
                    onTap: () {
                      if (user.token.isEmpty) {
                        ...
                        if (user.sem == '06' || user.sem == '6') {
                          ...
                          openSnackbar(
                              context,
                              "This game only for Diploma 6 Sem students",
                              Colors.red);
                        }
                      } else {
