...
class SharkTank extends StatefulWidget {
  const SharkTank({super.key});

  @override
  State<SharkTank> createState() => _SharkTankState();
}

class _SharkTankState extends State<SharkTank> {
  ...
  void _handleTap() {
    ...
    cart.addItem(
      CartItem(name: "SharkTank", price: 20, quantity: 2),
    );
  }
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "In this event student will come with new start up and give presentation how to implement this idea",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
