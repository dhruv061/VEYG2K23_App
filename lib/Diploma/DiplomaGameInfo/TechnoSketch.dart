...
class TechnoSketch extends StatefulWidget {
  const TechnoSketch({super.key});

  @override
  State<TechnoSketch> createState() => _TechnoSketchState();
}

class _TechnoSketchState extends State<TechnoSketch> {
  ...
  void _handleTap() {
    ...
    cart.addItem(
      CartItem(name: "Techno Sketch", price: 50, quantity: 1),
    );
  }
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "In this event student draw any technical drawing in drawing sheet and topic must be related to Technical.Topic would be selected by student themselfs",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
