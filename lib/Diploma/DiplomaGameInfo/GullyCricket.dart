...
class GullyCricket extends StatefulWidget {
  const GullyCricket({super.key});

  @override
  State<GullyCricket> createState() => _GullyCricketState();
}

class _GullyCricketState extends State<GullyCricket> {
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "In this event student will paly gully cricket",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
