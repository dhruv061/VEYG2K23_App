...
class OneMinuteGame extends StatefulWidget {
  const OneMinuteGame({super.key});

  @override
  State<OneMinuteGame> createState() => _OneMinuteGameState();
}

class _OneMinuteGameState extends State<OneMinuteGame> {
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "This event will be based on one minitue game",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
