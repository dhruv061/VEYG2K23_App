...
class TechOModel extends StatefulWidget {
  const TechOModel({super.key});

  @override
  State<TechOModel> createState() => _TechOModelState();
}

class _TechOModelState extends State<TechOModel> {
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: const [
                      Padding(
                        padding: EdgeInsets.only(top: 150, left: 13),
                        child: Text(
                          "In this event student will be made any technical model from waste material and give prentation on it",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
