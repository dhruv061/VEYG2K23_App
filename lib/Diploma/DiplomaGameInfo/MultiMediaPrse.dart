...
class MultiMediaPrse extends StatefulWidget {
  const MultiMediaPrse({super.key});

  @override
  State<MultiMediaPrse> createState() => _MultiMediaPrseState();
}

class _MultiMediaPrseState extends State<MultiMediaPrse> {
  ...
  void _handleTap() {
    ...
    cart.addItem(
      CartItem(name: "MultiMediaPrse", price: 20, quantity: 2),
    );
  }
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "In This event student make shorl film/ms powerpoint presentation on any technical topic",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
