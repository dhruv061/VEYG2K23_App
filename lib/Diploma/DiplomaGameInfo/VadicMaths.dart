...
class VadicMaths extends StatefulWidget {
  const VadicMaths({super.key});

  @override
  State<VadicMaths> createState() => _VadicMathsState();
}

class _VadicMathsState extends State<VadicMaths> {
                  ...
                  child: Column(
                    children: const [
                      Padding(
                        ...
                        child: Text(
                          "In this event student will be solved maths problem and  solve the puzzles",
                          style: TextStyle(
                            fontFamily: 'OpenSanse',
